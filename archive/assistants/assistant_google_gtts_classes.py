...
# class Recipe(object):
#     """docstring for RecipeScrapes"""
#     def __init__(self, title = "", time = "", instructions = [],
#                  ingredients = []):
#         self.title = title
#         self.time = time
...
# class ScrapeParser(object):
#     """docstring for ScrapeParser"""
...
#         # ALL ABBREVIATIONS
#         self.abbrevs = [abbrev for abbrevs in unit_types.values()
